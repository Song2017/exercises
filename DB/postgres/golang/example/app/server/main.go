...
// @title Sample CRUD api for main db
// @version 1.0
// @description Sample CRUD api for main db
// @termsOfService
...
`, BuildDate, BuildNumber, LatestCommit, RuntimeVer, BuiltOnOs)
	...
	db, err := gorm.Open("postgres", "postgresql://nomad_logistics_dev:mIPqf6kC0eqinBOFevwvgArLc0I487@pgm-6nn7xj3p540344s2167570.pg.rds.aliyuncs.com/nomad_logistics_dev?sslmode=disable")
	if err != nil {
