...
func ConfigRouter() http.Handler {
	...
	configFcConfigurationTemplateRouter(router)
...
func ConfigGinRouter(router gin.IRoutes) {
	configGinFcConfigurationTemplateRouter(router)
...
// GetDdl is a function to get table info for a table in the main database
// @Summary Get table info for a table in the main database by argID
// @Tags TableInfo
// @ID argID
// @Description GetDdl is a function to get table info for a table in the main database
// @Accept  json
// @Produce  json
...
// GetDdlEndpoints is a function to get a list of ddl endpoints available for tables in the main database
// @Summary Gets a list of ddl endpoints available for tables in the main database
// @Tags TableInfo
// @Description GetDdlEndpoints is a function to get a list of ddl endpoints available for tables in the main database
// @Accept  json
// @Produce  json
// @Success 200 {object} api.CrudAPI
// @Router /ddl [get]
...
func init() {
	...
	tmp = &CrudAPI{
		Name:            "fc_configuration_template",
		CreateURL:       "/fcconfigurationtemplate",
		RetrieveOneURL:  "/fcconfigurationtemplate",
		RetrieveManyURL: "/fcconfigurationtemplate",
		UpdateURL:       "/fcconfigurationtemplate",
		DeleteURL:       "/fcconfigurationtemplate",
		FetchDDLURL:     "/ddl/fc_configuration_template",
	}

	tmp.TableInfo, _ = model.GetTableInfo("fc_configuration_template")
	crudEndpoints["fc_configuration_template"] = tmp
